...
/*------------------------------------------------------*/
	"mysql"=>array(
		"servidor"=>"localhost",
		"usuario"=>"technext_walger_user",
		"contrasena"=>"*Walger000#25",
		"base"=>"technext_walger"	
	),
	"conexionesexternas"=>
		array(
			array(
...
/*------------------------------------------------------*/	
	"captchasecret"=>"6LezBvUrAAAAABWY-FPxG_VZUZ5GqfM3yMZKWU3c",
	"captchasitekey"=>"6LezBvUrAAAAANTxHLGWEjymxoMWRsTkud0r2dD7",
/*------------------------------------------------------*/	
	"limitelogmails"=>100,
/*------------------------------------------------------*/	
	"carpetaimagenes"=>"img/",
	...
	"carpetauploadremoto"=>"https://servidor2.walger.ar/articulos/", /*Revisar*/
	"carpetapdffacturas"=>"/home/technext/servidor2.walger.ar/fcisis/",

	"imagenqrmercadopago" => "qr.jpg",	
/*------------------------------------------------------*/
	"pdffacturas"=>TRUE,
/*------------------------------------------------------*/
	"descargarlistadeprecios"=>TRUE,
/*------------------------------------------------------*/
	"host"=>"servidor2.walger.ar",
/*------------------------------------------------------*/
	"checkout"=>FALSE,
/*------------------------------------------------------*/
	...
	"camposregistro"=>array(
		...
		"flete"=>array(
			...
			"valordefault"=>"",
			"obligatorio"=>FALSE,
			"nombre"=>"Flete (Razón Social)"
		),
		"apellido-nombre"=>array(
			"mostrar"=>TRUE,
			"valordefault"=>"",
			"obligatorio"=>FALSE,
...
/*------------------------------------------------------*/		
	...
	array(
		array(
			...
			"link"=>"https://wa.me/5491160943285"
...
/*------------------------------------------------------*/		
	...
	array(
		...
		"avisoexistencia"=>TRUE,
		"textoexistencia"=>"Stock Disponible",		
