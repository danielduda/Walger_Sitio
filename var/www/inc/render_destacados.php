  ...
  //$tipo permite "ofertas" o "novedades"
	...
	?>
        ...
        <section id="destacados" class="well3 center">
          <div class="">
            <h3 style="margin-top:10px;margin-bottom:10px" class="bold titulo"><?php echo $tipo=="ofertas"? "Ofertas" : "Novedades" ?></h3>
          </div>
          <div class="">
            <div class="row">
                ...
                <?php 
                  ...
                  if($productosDestacados["error"]==true){
                    ...
                    for ($i=0; $i < count($productosDestacados["exito"]); $i++) {
                      ?>
                      <div style="margin:5px" class="destacados-contenedor producto item" data-codigo-producto="<?php echo $productosDestacados["exito"][$i]["CodInternoArti"] ?>">
                        <div class="destacados-inner">
                          <div class="col-md-12 col-sm-6">
                            <div class="destacados-imagen" >
                              <img onmouseover="aplicaElevateZoomDestacados(this)" src="<?php echo $GLOBALS["configuracion"]["carpetauploadremoto"].$productosDestacados["exito"][$i]["NombreFotoArti"] ?>" alt="">
                            </div>                      
                          </div>
                          ...
                          ?>
                            <h5><?php echo $productosDestacados["exito"][$i]["DescrNivelInt3"] ?></h5>
                            <a href="producto.php?codigo=<?php echo $productosDestacados["exito"][$i]["CodInternoArti"] ?>">
