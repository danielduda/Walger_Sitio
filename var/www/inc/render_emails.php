        ...
        <!--
          ...
          <div style="max-width: 680px; margin: auto;" class="email-container">
            ...
            <td>
            	...
            	<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
            		...
            		<tr>
            			<td bgcolor="#ffffff">
            				<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            					<tr>
            						<td style="padding: 40px 40px 20px 40px; font-family: sans-serif; font-size: 20px; line-height: 60px; color: #555555;">
            							[[encabezado]]
            						</td>
            					</tr>
            				</table>
            		...
            		<tr>
            			<td bgcolor="#ffffff">
            				<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            					<tr>
            						<td style="padding: 20px 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
										[[mensajehtml]]
            						</td>
            					</tr>
            				</table>
            	...
            	<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
            		<tr>
            			<td style="padding: 40px 10px;width: 100%;font-size: 12px; text-align:left; font-family: sans-serif; line-height:20px; color: #888888;" class="x-gmail-data-detectors">
										[[datospie]]
            			</td>
            		</tr>
            	</table>
