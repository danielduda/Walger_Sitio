...
class cusuarios extends cTable {
	...
	function __construct() {
		...
		// idUsuario
		$this->idUsuario = new cField('usuarios', 'usuarios', 'x_idUsuario', 'idUsuario', '`idUsuario`', '`idUsuario`', 19, -1, FALSE, '`idUsuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// contrasenia
		$this->contrasenia = new cField('usuarios', 'usuarios', 'x_contrasenia', 'contrasenia', '`contrasenia`', '`contrasenia`', 200, -1, FALSE, '`contrasenia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// idNivel
		$this->idNivel = new cField('usuarios', 'usuarios', 'x_idNivel', 'idNivel', '`idNivel`', '`idNivel`', 3, -1, FALSE, '`idNivel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->idNivel->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['idNivel'] = &$this->idNivel;

		// activo
		$this->activo = new cField('usuarios', 'usuarios', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->activo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['activo'] = &$this->activo;

		// observaciones
		$this->observaciones = new cField('usuarios', 'usuarios', 'x_observaciones', 'observaciones', '`observaciones`', '`observaciones`', 201, -1, FALSE, '`observaciones`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
   ...
   // Common render codes
	...
	function UserIDFilter($userid) {
		...
		$sParentUserIDFilter = '`idUsuario` IN (SELECT `idUsuario` FROM ' . "`usuarios`" . ' WHERE `idUsuario` = ' . ew_QuotedValue($userid, EW_DATATYPE_NUMBER) . ')';
