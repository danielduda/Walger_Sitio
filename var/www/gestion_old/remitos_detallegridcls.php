...
$remitos_detalle_grid = NULL; // Initialize page object first

class cremitos_detalle_grid extends cremitos_detalle {
	...
	// Page object name
	var $PageObjName = 'remitos_detalle_grid';

	// Grid form hidden field names
	var $FormName = 'fremitos_detallegrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["remitos_detalle"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function RenderListOptions() {
		...
		if ($this->CurrentMode == "edit" && is_numeric($this->RowIndex)) {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $KeyName . "\" id=\"" . $KeyName . "\" value=\"" . $this->Id_RemitoDetalle->CurrentValue . "\">";
		}
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->remitoCabecera->getSessionValue() <> "") {
			$rsnew['remitoCabecera'] = $this->remitoCabecera->getSessionValue();
		}
