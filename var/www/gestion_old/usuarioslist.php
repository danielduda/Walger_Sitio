...
class cusuarios_list extends cusuarios {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->apellido, $Keyword);
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label class=\"checkbox\"><input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->idUsuario->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'></label>";
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_usuarios\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_usuarios',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fusuarioslist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
fusuarioslist.Lists["x_idNivel"] = {"LinkField":"x_idNivel","Ajax":null,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($usuarios->idUsuario->Visible) { // idUsuario ?>
	<?php if ($usuarios->SortUrl($usuarios->idUsuario) == "") { ?>
		<td><div id="elh_usuarios_idUsuario" class="usuarios_idUsuario"><div class="ewTableHeaderCaption"><?php echo $usuarios->idUsuario->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->idUsuario) ?>',1);"><div id="elh_usuarios_idUsuario" class="usuarios_idUsuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->idUsuario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->idUsuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->idUsuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->usuario->Visible) { // usuario ?>
	<?php if ($usuarios->SortUrl($usuarios->usuario) == "") { ?>
		<td><div id="elh_usuarios_usuario" class="usuarios_usuario"><div class="ewTableHeaderCaption"><?php echo $usuarios->usuario->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->usuario) ?>',1);"><div id="elh_usuarios_usuario" class="usuarios_usuario">
...
<?php if ($usuarios->contrasenia->Visible) { // contrasenia ?>
	<?php if ($usuarios->SortUrl($usuarios->contrasenia) == "") { ?>
		<td><div id="elh_usuarios_contrasenia" class="usuarios_contrasenia"><div class="ewTableHeaderCaption"><?php echo $usuarios->contrasenia->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->contrasenia) ?>',1);"><div id="elh_usuarios_contrasenia" class="usuarios_contrasenia">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->contrasenia->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->contrasenia->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->contrasenia->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php if ($usuarios->apellido->Visible) { // apellido ?>
	<?php if ($usuarios->SortUrl($usuarios->apellido) == "") { ?>
		<td><div id="elh_usuarios_apellido" class="usuarios_apellido"><div class="ewTableHeaderCaption"><?php echo $usuarios->apellido->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->apellido) ?>',1);"><div id="elh_usuarios_apellido" class="usuarios_apellido">
...
<?php if ($usuarios->idNivel->Visible) { // idNivel ?>
	<?php if ($usuarios->SortUrl($usuarios->idNivel) == "") { ?>
		<td><div id="elh_usuarios_idNivel" class="usuarios_idNivel"><div class="ewTableHeaderCaption"><?php echo $usuarios->idNivel->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->idNivel) ?>',1);"><div id="elh_usuarios_idNivel" class="usuarios_idNivel">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->idNivel->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->idNivel->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->idNivel->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->activo->Visible) { // activo ?>
	<?php if ($usuarios->SortUrl($usuarios->activo) == "") { ?>
		<td><div id="elh_usuarios_activo" class="usuarios_activo"><div class="ewTableHeaderCaption"><?php echo $usuarios->activo->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->activo) ?>',1);"><div id="elh_usuarios_activo" class="usuarios_activo">
...
<?php echo $usuarios->idUsuario->ListViewValue() ?></span>
