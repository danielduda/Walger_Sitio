...
$remitosclientes = NULL;

//
// Table class for remitosclientes
//
class cremitosclientes extends cTable {
	var $Id_Remito;
	var $CodigoCli;
	var $RazonSocialCli;
	var $Direccion;
	...
	function __construct() {
		...
		$this->TableVar = 'remitosclientes';
		$this->TableName = 'remitosclientes';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Id_Remito
		$this->Id_Remito = new cField('remitosclientes', 'remitosclientes', 'x_Id_Remito', 'Id_Remito', '`Id_Remito`', '`Id_Remito`', 19, -1, FALSE, '`Id_Remito`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Remito->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Remito'] = &$this->Id_Remito;

		// CodigoCli
		$this->CodigoCli = new cField('remitosclientes', 'remitosclientes', 'x_CodigoCli', 'CodigoCli', '`CodigoCli`', '`CodigoCli`', 200, -1, FALSE, '`CodigoCli`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CodigoCli'] = &$this->CodigoCli;

		// RazonSocialCli
		$this->RazonSocialCli = new cField('remitosclientes', 'remitosclientes', 'x_RazonSocialCli', 'RazonSocialCli', '`RazonSocialCli`', '`RazonSocialCli`', 200, -1, FALSE, '`RazonSocialCli`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['RazonSocialCli'] = &$this->RazonSocialCli;

		// Direccion
		$this->Direccion = new cField('remitosclientes', 'remitosclientes', 'x_Direccion', 'Direccion', '`Direccion`', '`Direccion`', 200, -1, FALSE, '`Direccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Direccion'] = &$this->Direccion;

		// LocalidadCli
		$this->LocalidadCli = new cField('remitosclientes', 'remitosclientes', 'x_LocalidadCli', 'LocalidadCli', '`LocalidadCli`', '`LocalidadCli`', 200, -1, FALSE, '`LocalidadCli`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`remitosclientes`";
	...
	function SqlKeyFilter() {
		return "`Id_Remito` = @Id_Remito@ AND `CodigoCli` = '@CodigoCli@'";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "remitosclienteslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("remitosclientesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("remitosclientesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "remitosclientesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("remitosclientesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("remitosclientesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("remitosclientesdelete.php", $this->UrlParm());
	}
