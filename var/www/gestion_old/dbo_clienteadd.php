...
$dbo_cliente_add = NULL; // Initialize page object first

class cdbo_cliente_add extends cdbo_cliente {
	...
	// Page object name
	var $PageObjName = 'dbo_cliente_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("dbo_clientelist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($dbo_cliente_add)) $dbo_cliente_add = new cdbo_cliente_add();

// Page init
$dbo_cliente_add->Page_Init();

// Page main
$dbo_cliente_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$dbo_cliente_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var dbo_cliente_add = new ew_Page("dbo_cliente_add");
dbo_cliente_add.PageID = "add"; // Page ID
var EW_PAGE_ID = dbo_cliente_add.PageID; // For backward compatibility

// Form object
var fdbo_clienteadd = new ew_Form("fdbo_clienteadd");

// Validate form
fdbo_clienteadd.Validate = function() {
...
fdbo_clienteadd.Form_CustomValidate = 
...
fdbo_clienteadd.ValidateRequired = true;
<?php } else { ?>
fdbo_clienteadd.ValidateRequired = false; 
<?php } ?>
...
<?php $dbo_cliente_add->ShowPageHeader(); ?>
<?php
$dbo_cliente_add->ShowMessage();
?>
<form name="fdbo_clienteadd" id="fdbo_clienteadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="dbo_cliente">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_dbo_clienteadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fdbo_clienteadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$dbo_cliente_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$dbo_cliente_add->Page_Terminate();
?>
