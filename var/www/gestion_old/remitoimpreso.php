...
$qcabecera=mysql_query($qcabecera);
$fcabecera=mysql_fetch_assoc($qcabecera);
...
//echo $qdetalle;
$qdetalle=mysql_query($qdetalle);
//echo mysql_num_rows($qdetalle);
$detalles=array();
for ($i=0; $i <mysql_num_rows($qdetalle) ; $i++) { 
	$fdetalle=mysql_fetch_assoc($qdetalle);
