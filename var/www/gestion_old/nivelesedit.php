...
$niveles_edit = NULL; // Initialize page object first

class cniveles_edit extends cniveles {
...
// Create page object
if (!isset($niveles_edit)) $niveles_edit = new cniveles_edit();
...
// Form object
var fnivelesedit = new ew_Form("fnivelesedit");

// Validate form
fnivelesedit.Validate = function() {
...
fnivelesedit.Form_CustomValidate = 
...
fnivelesedit.ValidateRequired = true;
<?php } else { ?>
fnivelesedit.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fnivelesedit" id="fnivelesedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="niveles">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_nivelesedit" class="table table-bordered table-striped">
...
<?php echo $niveles->idNivel->EditValue ?></span>
</span>
<input type="hidden" data-field="x_idNivel" name="x_idNivel" id="x_idNivel" value="<?php echo ew_HtmlEncode($niveles->idNivel->CurrentValue) ?>">
