...
<?php } ?>
<link href="phpcss/custom.css" rel="stylesheet" type="text/css">
...
<!-- powered by juno - multiple theme extension for phpmaker - http://codecanyon.net/user/simon81/portfolio-->
...
<?php
echo '<link href="select2/select2.css" rel="stylesheet">';
echo '<script src="select2/select2.min.js"></script>'; 

//echo '<script src="select2/select2_locale_es.js"></script>';  
?>
<script type="text/javascript">
...
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("fav.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("fav.ico") ?>">
...
<?php if (!ew_IsMobile()) { ?>
  ...
  <div id="ewHeaderRow" class="ewHeaderRow"><img src="phpimages/Logo_Walger.png" alt="" style="border: 0;">	</div>
	<!-- header (end) -->
<?php } ?>
<?php if (ew_IsMobile()) { ?>
