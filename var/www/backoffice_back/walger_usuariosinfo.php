...
$walger_usuarios = NULL;

//
// Table class for walger_usuarios
//
class cwalger_usuarios extends cTable {
	var $idUsuario;
	var $usuario;
	var $contrasenia;
	...
	function __construct() {
		...
		$this->TableVar = 'walger_usuarios';
		$this->TableName = 'walger_usuarios';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`walger_usuarios`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// idUsuario
		$this->idUsuario = new cField('walger_usuarios', 'walger_usuarios', 'x_idUsuario', 'idUsuario', '`idUsuario`', '`idUsuario`', 19, -1, FALSE, '`idUsuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// usuario
		$this->usuario = new cField('walger_usuarios', 'walger_usuarios', 'x_usuario', 'usuario', '`usuario`', '`usuario`', 200, -1, FALSE, '`usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->usuario->Sortable = TRUE; // Allow sort
		$this->fields['usuario'] = &$this->usuario;

		// contrasenia
		$this->contrasenia = new cField('walger_usuarios', 'walger_usuarios', 'x_contrasenia', 'contrasenia', '`contrasenia`', '`contrasenia`', 200, -1, FALSE, '`contrasenia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->contrasenia->Sortable = FALSE; // Allow sort
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`walger_usuarios`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "walger_usuarioslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("walger_usuariosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("walger_usuariosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "walger_usuariosadd.php?" . $this->UrlParm($parm);
		else
			$url = "walger_usuariosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("walger_usuariosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("walger_usuariosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("walger_usuariosdelete.php", $this->UrlParm());
	}
