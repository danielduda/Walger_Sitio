...
$trama_mensajes2Dpublicos2Dleidos_grid = NULL; // Initialize page object first

class ctrama_mensajes2Dpublicos2Dleidos_grid extends ctrama_mensajes2Dpublicos2Dleidos {
	...
	// Page object name
	var $PageObjName = 'trama_mensajes2Dpublicos2Dleidos_grid';

	// Grid form hidden field names
	var $FormName = 'ftrama_mensajes2Dpublicos2Dleidosgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["trama_mensajes2Dpublicos2Dleidos"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->idMensajePublico->getSessionValue() <> "") {
			$rsnew['idMensajePublico'] = $this->idMensajePublico->getSessionValue();
		}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "walger_ofertas") {
			$this->idMensajePublico->Visible = FALSE;
			if ($GLOBALS["walger_ofertas"]->EventCancelled) $this->EventCancelled = TRUE;
		}
