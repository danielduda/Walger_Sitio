...
//
// Table class for trama_slider
//
class ctrama_slider extends cTable {
	var $id;
	var $titulo;
	var $imagen;
	var $contenido;
	...
	function __construct() {
		...
		$this->TableVar = 'trama_slider';
		$this->TableName = 'trama_slider';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trama_slider`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('trama_slider', 'trama_slider', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// titulo
		$this->titulo = new cField('trama_slider', 'trama_slider', 'x_titulo', 'titulo', '`titulo`', '`titulo`', 200, -1, FALSE, '`titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->titulo->Sortable = TRUE; // Allow sort
		$this->fields['titulo'] = &$this->titulo;

		// imagen
		$this->imagen = new cField('trama_slider', 'trama_slider', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 200, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen->Sortable = TRUE; // Allow sort
		$this->fields['imagen'] = &$this->imagen;

		// contenido
		$this->contenido = new cField('trama_slider', 'trama_slider', 'x_contenido', 'contenido', '`contenido`', '`contenido`', 201, -1, FALSE, '`contenido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->contenido->Sortable = TRUE; // Allow sort
		$this->fields['contenido'] = &$this->contenido;

		// link
		$this->link = new cField('trama_slider', 'trama_slider', 'x_link', 'link', '`link`', '`link`', 200, -1, FALSE, '`link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->link->Sortable = TRUE; // Allow sort
		$this->fields['link'] = &$this->link;

		// activo
		$this->activo = new cField('trama_slider', 'trama_slider', 'x_activo', 'activo', '`activo`', '`activo`', 17, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trama_slider`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trama_sliderview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trama_sliderview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trama_slideradd.php?" . $this->UrlParm($parm);
		else
			$url = "trama_slideradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trama_slideredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trama_slideradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trama_sliderdelete.php", $this->UrlParm());
	}
