...
<?php if ($dbo_articulo->CodInternoArti->Visible) { // CodInternoArti ?>
	<div id="r_CodInternoArti" class="form-group">
		<label id="elh_dbo_articulo_CodInternoArti" for="x_CodInternoArti" class="col-sm-2 control-label ewLabel"><?php echo $dbo_articulo->CodInternoArti->FldCaption() ?></label>
