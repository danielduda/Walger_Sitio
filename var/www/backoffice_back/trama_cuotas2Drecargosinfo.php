...
$trama_cuotas2Drecargos = NULL;

//
// Table class for trama_cuotas-recargos
//
class ctrama_cuotas2Drecargos extends cTable {
	var $id;
	var $idMedioPago;
	var $cuotas;
	var $recargo;
	...
	function __construct() {
		...
		$this->TableVar = 'trama_cuotas2Drecargos';
		$this->TableName = 'trama_cuotas-recargos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trama_cuotas-recargos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('trama_cuotas2Drecargos', 'trama_cuotas-recargos', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idMedioPago
		$this->idMedioPago = new cField('trama_cuotas2Drecargos', 'trama_cuotas-recargos', 'x_idMedioPago', 'idMedioPago', '`idMedioPago`', '`idMedioPago`', 3, -1, FALSE, '`idMedioPago`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// cuotas
		$this->cuotas = new cField('trama_cuotas2Drecargos', 'trama_cuotas-recargos', 'x_cuotas', 'cuotas', '`cuotas`', '`cuotas`', 3, -1, FALSE, '`cuotas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// recargo
		$this->recargo = new cField('trama_cuotas2Drecargos', 'trama_cuotas-recargos', 'x_recargo', 'recargo', '`recargo`', '`recargo`', 4, -1, FALSE, '`recargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->recargo->Sortable = TRUE; // Allow sort
		$this->recargo->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['recargo'] = &$this->recargo;

		// activo
		$this->activo = new cField('trama_cuotas2Drecargos', 'trama_cuotas-recargos', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trama_cuotas-recargos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "trama_cuotas2Drecargoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trama_cuotas2Drecargosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trama_cuotas2Drecargosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trama_cuotas2Drecargosadd.php?" . $this->UrlParm($parm);
		else
			$url = "trama_cuotas2Drecargosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trama_cuotas2Drecargosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trama_cuotas2Drecargosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trama_cuotas2Drecargosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->recargo->EditValue = $this->recargo->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->recargo->Exportable) $Doc->ExportCaption($this->recargo);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->recargo->Exportable) $Doc->ExportField($this->recargo);
