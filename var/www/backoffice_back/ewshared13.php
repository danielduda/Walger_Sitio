...
function Menu_Rendering(&$Menu) {
	global $nombre_menu_remoto;
	global $nombre_menu_trama;
	global $nombre_menu_remoto_auxiliares;
	global $nombre_menu_trama_auxiliares;
	global $gsMenuColumnClass;
	if(isset($_SESSION["MenuClassNameDisplay"]))
		if(!$_SESSION["MenuClassNameDisplay"])
			$gsMenuColumnClass = "displayNone";
	$Menu->ItemData[0]->Text = $nombre_menu_remoto; 
	$Menu->ItemData[1]->Text = $nombre_menu_trama;	
	$Menu->ItemData[2]->Text = $nombre_menu_remoto_auxiliares;	
	$Menu->ItemData[3]->Text = $nombre_menu_trama_auxiliares;	
}
