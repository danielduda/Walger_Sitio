...
document.write('<script async src="https://www.googletagmanager.com/gtag/js?id=G-M9DGB36ZWQ"></script>');
//document.write('<script async src="https://www.googletagmanager.com/gtag/js?id=UA-7680832-2"></script>');
...
$(document).ready(function(){
  ...
  gtag('config', 'G-M9DGB36ZWQ');
  //gtag('config', 'UA-7680832-2');
...
function aplicaElevateZoomDestacados(elemento){
...
function ocultarMostrarCampos(elemento){
    $("[data-dependiente='"+$(elemento).attr("id")+"']").each(function( index ) {
        if ($(this).data("visible")[$(elemento).val()]==true) {
        ...
        success: function (response) {
            ...
            if (response["error"]==false) {
                ...
                for (var i = 0; i < Object.keys(response["exito"]).length; i++) {
                    ...
                    if (Object.keys(response["exito"][i]["NombreFotoArti"]).length==1) {
                        html+='<img class="productos-imagen-cargando" onmouseover="aplicaElevateZoom(this)" src="'+response["adicionales"]["carpetaupload"]+response["exito"][i]["NombreFotoArti"][0]+'" style="display:none" alt="">';                        
                    }else{

                        html+='<div class="imagenes-dots text-center">'
                        html+='<span class="pull-left control-imagen"><i onclick="imagenAnterior(this)" class="fa fa-chevron-circle-left fa-lg cl-color-1" aria-hidden="true"></i></span>'


                        for (var i2 = 0; i2 < Object.keys(response["exito"][i]["NombreFotoArti"]).length; i2++) {
                            if (i2==0) {
                                html+='<span onclick="cambiarImagen(this, 0)" data-dot-orden="0" class="imagenes-dot active"><i class="fa fa-circle" aria-hidden="true"></i></span>'

                            }else{

                                html+='<span onclick="cambiarImagen(this, '+i2+')" data-dot-orden="'+i2+'" class="imagenes-dot"><i class="fa fa-circle" aria-hidden="true"></i></span>'
                            };
                        
                        }                        
                        
                        html+='<span class="pull-right control-imagen"><i onclick="imagenSiguiente(this)" class="fa fa-chevron-circle-right fa-lg cl-color-1" aria-hidden="true"></i></span>'                        
                        html+='</div>'

                        html+='<img data-imagen-orden="0" class="productos-imagen-cargando active" onmouseover="aplicaElevateZoom(this)" src="'+response["adicionales"]["carpetaupload"]+response["exito"][i]["NombreFotoArti"][0]+'" style="display:none" alt="">';                        
                        for (var i2 = 1; i2 < Object.keys(response["exito"][i]["NombreFotoArti"]).length; i2++) {
                            html+='<div data-imagen-orden="'+i2+'" class="productos-imagen-cargando" data-src="'+response["adicionales"]["carpetaupload"]+response["exito"][i]["NombreFotoArti"][i2]+'"></div>'        
                        }
                        
                        html+='<span class="imagen-icono-multiple"><i class="fa fa-clone fa-lg" aria-hidden="true"></i></span>'
                    ...
                    html+='<div class="col-md-6 col-sm-5 productos-titulo mayuscula">'
                        if (response["adicionales"] ["detallemodal"]==true) {
                            html+='<a href="producto.php?codigo='+response["exito"][i]["CodInternoArti"]+'">'
                    ...
                    if (Object.keys(response["exito"][i]["atributos"]).length>0) {
                            ...
                            if (response["adicionales"]["comprarsinexistencia"]===false) {
                                ...
                                if (response["adicionales"]["avisopocaexistencia"]===true) {
                                    if (parseFloat(response["exito"][i]["Stock1_StkArti"])<response["adicionales"]["cantidadpocaexistencia"]) {
                                        ...
                                        html+='</div>'
                                        html+='<div>'
                                        html+='<h6 style="color:red"><strong>'+response["adicionales"]["textopocaexistencia"]+'</strong></h6>'
                                    }else{
                                        if (response["adicionales"]["avisoexistencia"]===true) {
                                            html+='<input onchange="valorCantidad(this)" id="cantidad-pedida" name="" class="form-control" placeholder="" type="number" min="1" max="9999999" value="1">'
                                            html+='<span class="input-group-addon"><a onclick="agregarCesta(this)" class="btn btn-danger" href="javascript:void(0);"><i class="fa fa-cart-plus" aria-hidden="true"></i></a></span>'
                                            html+='</div>'
                                            html+='<div>'
                                            html+='<h6 style="color:green"><strong>'+response["adicionales"]["textoexistencia"]+'</strong></h6>'                                        
                                        }else{
                        ...
                        html+='</div>'                          
                    html+='</div>'                                           
                    html+='<div class="col-xs-12 contenedor-descripcion text-justify">'
                ...
                if ($(".productos-contenedor").hasClass("grilla")) {
                 ...
                 $('.productos-contenedor').waitForImages(function() {
                    if ($(".productos-contenedor").hasClass("grilla")) {
                       ...
                       $(".productos-imagen-cargando").show();
                       $(".productos-imagen-cargando").addClass("productos-imagen").removeClass("productos-imagen-cargando")
                       productosMostrarGrilla();
                    }else{
                        $(".spinner-producto").hide();
                        $(".productos-imagen-cargando").show();
...
function cambiarImagen(elemento, orden){

    var ordenanterior=$(elemento).closest(".productos-contenedor-imagen").find(".productos-imagen.active").attr("data-imagen-orden");
    $(elemento).closest(".productos-contenedor-imagen").find("[data-imagen-orden='"+ordenanterior+"']" ).removeClass("active").hide();

    $(elemento).closest(".productos-contenedor-imagen").find(".imagenes-dot").removeClass("active");
    $(elemento).closest(".productos-contenedor-imagen").find("[data-dot-orden='"+orden+"']").addClass("active");
    
    if ($(elemento).closest(".productos-contenedor-imagen").find("[data-imagen-orden='"+orden+"']" ).is("div")) {
        $(elemento).closest(".productos-contenedor-imagen").find(".spinner-producto").show();
        var src=$(elemento).closest(".productos-contenedor-imagen").find("[data-imagen-orden='"+orden+"']" ).attr("data-src");

        var html='<img data-imagen-orden="'+orden+'" class="productos-imagen-cargando active" onmouseover="aplicaElevateZoom(this)" style="display:none" src="'+src+'" alt="">';                        

        $(elemento).closest(".productos-contenedor-imagen").find("[data-imagen-orden='"+orden+"']" ).replaceWith(html);


    }else{
        $(elemento).closest(".productos-contenedor-imagen").find("[data-imagen-orden='"+orden+"']" ).addClass("active").show();
    };
...
function imagenSiguiente(elemento){

    var ordenanterior=$(elemento).closest(".productos-contenedor-imagen").find(".productos-imagen.active").attr("data-imagen-orden");
    
    var cantidadimagenes=$(elemento).closest(".productos-contenedor-imagen").find(".productos-imagen").length;

    if (ordenanterior==cantidadimagenes-1) {
        var orden=0;
    }else{
        var orden=parseInt(ordenanterior+1);    
    };

    cambiarImagen(elemento, orden);

}

function imagenAnterior(elemento){
    ...
    if (ordenanterior==0) {
        var orden=cantidadimagenes-1;
    }else{
        var orden=ordenanterior-1;    
    };
...
function cambiaFotoProducto(elemento){

    $("#imagen-principal").attr("src",$(elemento).attr("data-src"));

    $(".inner-thumb").removeClass("active");
...
function mostrarProducto(codigo){
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (Object.keys(response["exito"][0]["NombreFotoArti"]).length==1) {
                html+='<img class="productos-imagen" onmouseover="aplicaElevateZoom(this)" src="'+ response["adicionales"]["carpetaupload"]+response["exito"][0]["NombreFotoArti"][0]+'" alt="">'
            }else{

                html+='<img id="imagen-principal" class="productos-imagen" onmouseover="aplicaElevateZoom(this)" src="'+ response["adicionales"]["carpetaupload"]+response["exito"][0]["NombreFotoArti"][0]+'" alt="">'

                for (var i2 = 0; i2 < Object.keys(response["exito"][0]["NombreFotoArti"]).length; i2++) {

                    if (i2==0) {
                    
                        html+='<div class="col-xs-4"><div class="inner-thumb active" data-src="'+ response["adicionales"]["carpetaupload"]+response["exito"][0]["NombreFotoArti"][i2]+'" style="background-image:url('+"'"+ response["adicionales"]["carpetaupload"]+response["exito"][0]["NombreFotoArti"][i2]+"'"+')" onclick="cambiaFotoProducto(this)"></div></div>'

                    }else{

                        html+='<div class="col-xs-4"><div class="inner-thumb" data-src="'+ response["adicionales"]["carpetaupload"]+response["exito"][0]["NombreFotoArti"][i2]+'" style="background-image:url('+"'"+ response["adicionales"]["carpetaupload"]+response["exito"][0]["NombreFotoArti"][i2]+"'"+')" onclick="cambiaFotoProducto(this)"></div></div>'
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response["error"]==true) {
                ...
                if (response["adicionales"]["accionalcomprar"]!="") {
                    if (response["adicionales"]["accionalcomprar"]=="modal") {
                        $("#modal-mensaje-texto").empty();

                        var html='';
                        html +='Producto Agregado. ¿Cómo desea continuar? <br/>'
                        html +='<a style="margin-top:10px;margin-right:10px" data-dismiss="modal" class="btn btn-primary btn-sm" href="">Continuar Comprando</a>'
                        html +='<a style="margin-top:10px" class="btn btn-primary btn-sm" href="carrito.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Ir a Mi Carrito</a>'

                        $("#modal-mensaje-texto").html(html);
        ...
        success: function (response) {
            if (response["error"]==true) {
                ...
                for (var i = 0; i < Object.keys(response["exito"]).length; i++) {
                    ...
                    if (response["exito"][i]["linkpdf"]!="") {
                        html+='<td><a target="_blank" href="'+response["exito"][i]["linkpdf"]+'">'+response["exito"][i]["Abreviatura"]+' - '+response["exito"][i]["NroComprob_CliTra"]+'</a></td>'                   
                    }else{
