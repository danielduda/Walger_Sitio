...
fusuariosview.Lists["x_idNivel"] = {"LinkField":"x_idNivel","Ajax":null,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php echo $usuarios->idUsuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($usuarios->contrasenia->Visible) { // contrasenia ?>
	<tr id="r_contrasenia">
		<td><span id="elh_usuarios_contrasenia"><?php echo $usuarios->contrasenia->FldCaption() ?></span></td>
...
<?php echo $usuarios->contrasenia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($usuarios->idNivel->Visible) { // idNivel ?>
	<tr id="r_idNivel">
		<td><span id="elh_usuarios_idNivel"><?php echo $usuarios->idNivel->FldCaption() ?></span></td>
...
<?php echo $usuarios->idNivel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $usuarios->observaciones->ViewAttributes() ?>>
<?php echo $usuarios->observaciones->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
