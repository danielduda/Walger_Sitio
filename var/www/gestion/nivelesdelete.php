...
$niveles_delete = NULL; // Initialize page object first

class cniveles_delete extends cniveles {
...
// Create page object
if (!isset($niveles_delete)) $niveles_delete = new cniveles_delete();
...
// Form object
var fnivelesdelete = new ew_Form("fnivelesdelete");

// Form_CustomValidate event
fnivelesdelete.Form_CustomValidate = 
...
fnivelesdelete.ValidateRequired = true;
<?php } else { ?>
fnivelesdelete.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fnivelesdelete" id="fnivelesdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_nivelesdelete" class="ewTable ewTableSeparate">
<?php echo $niveles->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($niveles->idNivel->Visible) { // idNivel ?>
		<td><span id="elh_niveles_idNivel" class="niveles_idNivel"><?php echo $niveles->idNivel->FldCaption() ?></span></td>
<?php } ?>
<?php if ($niveles->denominacion->Visible) { // denominacion ?>
		<td><span id="elh_niveles_denominacion" class="niveles_denominacion"><?php echo $niveles->denominacion->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $niveles_delete->RowCnt ?>_niveles_idNivel" class="control-group niveles_idNivel">
...
<span id="el<?php echo $niveles_delete->RowCnt ?>_niveles_denominacion" class="control-group niveles_denominacion">
