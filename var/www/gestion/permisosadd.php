...
class cpermisos_add extends cpermisos {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "permisosview.php")
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->tabla->PlaceHolder = ew_HtmlEncode(ew_RemoveHtml($this->tabla->FldCaption()));
	...
	function AddRow($rsold = NULL) {
		...
		// Check if key value entered
		if ($bInsertRow && $this->ValidateKey && $this->tabla->CurrentValue == "" && $this->tabla->getSessionValue() == "") {
			$this->setFailureMessage($Language->Phrase("InvalidKeyValue"));
			$bInsertRow = FALSE;
		}
...
// Page object
var permisos_add = new ew_Page("permisos_add");
permisos_add.PageID = "add"; // Page ID
var EW_PAGE_ID = permisos_add.PageID; // For backward compatibility

// Form object
var fpermisosadd = new ew_Form("fpermisosadd");
...
?>
<form name="fpermisosadd" id="fpermisosadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="permisos">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_permisosadd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_idNivel" name="x_idNivel" id="x_idNivel" size="30" placeholder="<?php echo $permisos->idNivel->PlaceHolder ?>" value="<?php echo $permisos->idNivel->EditValue ?>"<?php echo $permisos->idNivel->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_tabla" name="x_tabla" id="x_tabla" size="30" maxlength="255" placeholder="<?php echo $permisos->tabla->PlaceHolder ?>" value="<?php echo $permisos->tabla->EditValue ?>"<?php echo $permisos->tabla->EditAttributes() ?>>
</span>
