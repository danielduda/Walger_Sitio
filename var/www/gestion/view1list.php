...
class cview1_list extends cview1 {
	...
	echo '<div id="autoincrement">';
		echo '<form action="remitoslist.php" method="post">';
					...
					$qu=mysqli_query($GLOBALS['CURRENT_CONNECTION_MYSQL'], $qu);
						...
						echo "El n�mero ingresado debe ser mayor al �ltimo remito";
					}
					 }                                              
		...
		echo '<input class="btn btn-primary ewButton" name="actualizar" type="submit" value="Actualzar numeraci�n" onClick="window.location.reload()">';
		echo '</div>';
		echo '</form>';
		echo '</div>';  
	}
...
?>
<?php if ($view1->_1->Visible) { // 1 ?>
	<?php if ($view1->SortUrl($view1->_1) == "") { ?>
		<td><div id="elh_view1__1" class="view1__1"><div class="ewTableHeaderCaption"><?php echo $view1->_1->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->_1) ?>',1);"><div id="elh_view1__1" class="view1__1">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->_1->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($view1->_1->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->_1->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($view1->_1->Visible) { // 1 ?>
		<td<?php echo $view1->_1->CellAttributes() ?>>
<span<?php echo $view1->_1->ViewAttributes() ?>>
<?php echo $view1->_1->ListViewValue() ?></span>
