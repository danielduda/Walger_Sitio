...
define("EW_PROJECT_NAME", "GestiF3n_Walger", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{B81C6C2E-1100-4548-836E-685E96F6B551}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'XdeAHKN2YTib72AH', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/GestiF3n_Walger.css", TRUE); // Project stylesheet file name
define("EW_CHARSET", "iso-8859-1", TRUE); // Project charset
...
define("EW_CONN_PASS", 'walger0000', TRUE);
define("EW_CONN_DB", 'gestion_walger', TRUE);

// ADODB (Access/SQL Server)
define("EW_CODEPAGE", 28591, TRUE); // Code page
 ...
 * details.
 */
define("EW_ENCODING", "ISO-8859-1", TRUE); // Character encoding
 ...
 */
define("EW_MYSQL_CHARSET", "latin1", TRUE);
...
@define("EW_USER_LEVEL_NAME_FIELD", "`denominacion`", TRUE);
...
define("EW_DEFAULT_LOCALE", 'es_AR', TRUE);
