...
<body>
  ...
  $(document).ready(function(){
      ...
      var elementos=['.categoria-titulo1','.categoria-titulo2','.categoria-detalle','.novedades-titulo','.destacados-descripcion p', '.destacados-contenedor', '.destacados-descripcion'];
