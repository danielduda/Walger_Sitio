...
for ($i=0; $i < 10; $i++) { 
  ?>
  .nivel-<?php echo $i ?>{
    margin-left:<?php echo 20*$i ?>px;
    font-size:<?php echo 14-$i*2 ?>pt;
  }
  <?php
}
...
div.productos-imagen{
  height:0!important;
  min-height:0!important;
}

.control-imagen:hover{
  opacity:0.6;
}

.imagenes-dot:active, .imagenes-dot:focus{
  opacity:0.8;
}
...
.instagram-publicacion img{
    width:100%;
}

.instagram-publicacion:hover{
  -webkit-box-shadow: 2px 2px 20px 0px rgba(0,0,0,0.40);
  -moz-box-shadow: 2px 2px 20px 0px rgba(0,0,0,0.40);
  box-shadow: 2px 2px 20px 0px rgba(0,0,0,0.40);  
}

.instagram-publicacion div {
    height: 100%;
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center, center;
