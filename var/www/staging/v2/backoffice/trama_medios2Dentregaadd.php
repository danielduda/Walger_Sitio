...
$trama_medios2Dentrega_add = NULL; // Initialize page object first

class ctrama_medios2Dentrega_add extends ctrama_medios2Dentrega {
	...
	// Page object name
	var $PageObjName = 'trama_medios2Dentrega_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "trama_medios2Dentregaview.php")
...
// Create page object
if (!isset($trama_medios2Dentrega_add)) $trama_medios2Dentrega_add = new ctrama_medios2Dentrega_add();

// Page init
$trama_medios2Dentrega_add->Page_Init();

// Page main
$trama_medios2Dentrega_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trama_medios2Dentrega_add->Page_Render();
?>
...
var CurrentForm = ftrama_medios2Dentregaadd = new ew_Form("ftrama_medios2Dentregaadd", "add");

// Validate form
ftrama_medios2Dentregaadd.Validate = function() {
...
ftrama_medios2Dentregaadd.Form_CustomValidate = 
...
ftrama_medios2Dentregaadd.ValidateRequired = true;
<?php } else { ?>
ftrama_medios2Dentregaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftrama_medios2Dentregaadd.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftrama_medios2Dentregaadd.Lists["x_activo"].Options = <?php echo json_encode($trama_medios2Dentrega->activo->Options()) ?>;
...
<?php if (!$trama_medios2Dentrega_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $trama_medios2Dentrega_add->ShowPageHeader(); ?>
<?php
$trama_medios2Dentrega_add->ShowMessage();
?>
<form name="ftrama_medios2Dentregaadd" id="ftrama_medios2Dentregaadd" class="<?php echo $trama_medios2Dentrega_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trama_medios2Dentrega_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trama_medios2Dentrega_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $trama_medios2Dentrega_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftrama_medios2Dentregaadd.Init();
</script>
<?php
$trama_medios2Dentrega_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$trama_medios2Dentrega_add->Page_Terminate();
?>
