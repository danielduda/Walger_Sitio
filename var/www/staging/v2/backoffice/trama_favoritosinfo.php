...
$trama_favoritos = NULL;

//
// Table class for trama_favoritos
//
class ctrama_favoritos extends cTable {
	var $id;
	var $idUsuario;
	var $idArticulo;
	...
	function __construct() {
		...
		$this->TableVar = 'trama_favoritos';
		$this->TableName = 'trama_favoritos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trama_favoritos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('trama_favoritos', 'trama_favoritos', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idUsuario
		$this->idUsuario = new cField('trama_favoritos', 'trama_favoritos', 'x_idUsuario', 'idUsuario', '`idUsuario`', '`idUsuario`', 200, -1, FALSE, '`idUsuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->idUsuario->Sortable = TRUE; // Allow sort
		$this->idUsuario->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->idUsuario->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->idUsuario->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['idUsuario'] = &$this->idUsuario;

		// idArticulo
		$this->idArticulo = new cField('trama_favoritos', 'trama_favoritos', 'x_idArticulo', 'idArticulo', '`idArticulo`', '`idArticulo`', 200, -1, FALSE, '`idArticulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trama_favoritos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "trama_favoritoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trama_favoritosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trama_favoritosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trama_favoritosadd.php?" . $this->UrlParm($parm);
		else
			$url = "trama_favoritosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trama_favoritosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trama_favoritosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trama_favoritosdelete.php", $this->UrlParm());
	}
