...
$trama_lineas2Dproductos = NULL;

//
// Table class for trama_lineas-productos
//
class ctrama_lineas2Dproductos extends cTable {
	var $id;
	var $id_categoria;
	var $denominacion;
	...
	function __construct() {
		...
		$this->TableVar = 'trama_lineas2Dproductos';
		$this->TableName = 'trama_lineas-productos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trama_lineas-productos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('trama_lineas2Dproductos', 'trama_lineas-productos', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_categoria
		$this->id_categoria = new cField('trama_lineas2Dproductos', 'trama_lineas-productos', 'x_id_categoria', 'id_categoria', '`id_categoria`', '`id_categoria`', 3, -1, FALSE, '`id_categoria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->id_categoria->Sortable = TRUE; // Allow sort
		$this->id_categoria->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->id_categoria->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->id_categoria->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_categoria'] = &$this->id_categoria;

		// denominacion
		$this->denominacion = new cField('trama_lineas2Dproductos', 'trama_lineas-productos', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trama_lineas-productos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "trama_lineas2Dproductoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trama_lineas2Dproductosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trama_lineas2Dproductosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trama_lineas2Dproductosadd.php?" . $this->UrlParm($parm);
		else
			$url = "trama_lineas2Dproductosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trama_lineas2Dproductosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trama_lineas2Dproductosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trama_lineas2Dproductosdelete.php", $this->UrlParm());
	}
