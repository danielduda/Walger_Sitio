...
$trama_medios2Dentrega_edit = NULL; // Initialize page object first

class ctrama_medios2Dentrega_edit extends ctrama_medios2Dentrega {
	...
	// Page object name
	var $PageObjName = 'trama_medios2Dentrega_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("trama_medios2Dentregalist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("trama_medios2Dentregalist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "trama_medios2Dentregalist.php")
...
// Create page object
if (!isset($trama_medios2Dentrega_edit)) $trama_medios2Dentrega_edit = new ctrama_medios2Dentrega_edit();

// Page init
$trama_medios2Dentrega_edit->Page_Init();

// Page main
$trama_medios2Dentrega_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trama_medios2Dentrega_edit->Page_Render();
?>
...
var CurrentForm = ftrama_medios2Dentregaedit = new ew_Form("ftrama_medios2Dentregaedit", "edit");

// Validate form
ftrama_medios2Dentregaedit.Validate = function() {
...
ftrama_medios2Dentregaedit.Form_CustomValidate = 
...
ftrama_medios2Dentregaedit.ValidateRequired = true;
<?php } else { ?>
ftrama_medios2Dentregaedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftrama_medios2Dentregaedit.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftrama_medios2Dentregaedit.Lists["x_activo"].Options = <?php echo json_encode($trama_medios2Dentrega->activo->Options()) ?>;
...
<?php if (!$trama_medios2Dentrega_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $trama_medios2Dentrega_edit->ShowPageHeader(); ?>
<?php
$trama_medios2Dentrega_edit->ShowMessage();
?>
<form name="ftrama_medios2Dentregaedit" id="ftrama_medios2Dentregaedit" class="<?php echo $trama_medios2Dentrega_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trama_medios2Dentrega_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trama_medios2Dentrega_edit->Token ?>">
<?php } ?>
...
<?php if ($trama_medios2Dentrega->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_trama_medios2Dentrega_id" class="col-sm-2 control-label ewLabel"><?php echo $trama_medios2Dentrega->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $trama_medios2Dentrega->id->CellAttributes() ?>>
<span id="el_trama_medios2Dentrega_id">
<span<?php echo $trama_medios2Dentrega->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $trama_medios2Dentrega->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="trama_medios2Dentrega" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($trama_medios2Dentrega->id->CurrentValue) ?>">
<?php echo $trama_medios2Dentrega->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($trama_medios2Dentrega->denominacion->Visible) { // denominacion ?>
	<div id="r_denominacion" class="form-group">
		<label id="elh_trama_medios2Dentrega_denominacion" for="x_denominacion" class="col-sm-2 control-label ewLabel"><?php echo $trama_medios2Dentrega->denominacion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $trama_medios2Dentrega->denominacion->CellAttributes() ?>>
<span id="el_trama_medios2Dentrega_denominacion">
...
<?php echo $trama_medios2Dentrega->denominacion->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($trama_medios2Dentrega->importe->Visible) { // importe ?>
	<div id="r_importe" class="form-group">
		<label id="elh_trama_medios2Dentrega_importe" for="x_importe" class="col-sm-2 control-label ewLabel"><?php echo $trama_medios2Dentrega->importe->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $trama_medios2Dentrega->importe->CellAttributes() ?>>
<span id="el_trama_medios2Dentrega_importe">
...
<?php echo $trama_medios2Dentrega->importe->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($trama_medios2Dentrega->iva->Visible) { // iva ?>
	<div id="r_iva" class="form-group">
		<label id="elh_trama_medios2Dentrega_iva" for="x_iva" class="col-sm-2 control-label ewLabel"><?php echo $trama_medios2Dentrega->iva->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $trama_medios2Dentrega->iva->CellAttributes() ?>>
<span id="el_trama_medios2Dentrega_iva">
...
<?php echo $trama_medios2Dentrega->iva->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($trama_medios2Dentrega->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_trama_medios2Dentrega_activo" class="col-sm-2 control-label ewLabel"><?php echo $trama_medios2Dentrega->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $trama_medios2Dentrega->activo->CellAttributes() ?>>
<span id="el_trama_medios2Dentrega_activo">
...
<?php echo $trama_medios2Dentrega->activo->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$trama_medios2Dentrega_edit->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $trama_medios2Dentrega_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftrama_medios2Dentregaedit.Init();
</script>
<?php
$trama_medios2Dentrega_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$trama_medios2Dentrega_edit->Page_Terminate();
?>
