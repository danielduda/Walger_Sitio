...
$trama_medios2Dentrega = NULL;

//
// Table class for trama_medios-entrega
//
class ctrama_medios2Dentrega extends cTable {
	var $id;
	var $denominacion;
	var $importe;
	var $iva;
	...
	function __construct() {
		...
		$this->TableVar = 'trama_medios2Dentrega';
		$this->TableName = 'trama_medios-entrega';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trama_medios-entrega`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('trama_medios2Dentrega', 'trama_medios-entrega', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('trama_medios2Dentrega', 'trama_medios-entrega', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// importe
		$this->importe = new cField('trama_medios2Dentrega', 'trama_medios-entrega', 'x_importe', 'importe', '`importe`', '`importe`', 4, -1, FALSE, '`importe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->importe->Sortable = TRUE; // Allow sort
		$this->importe->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['importe'] = &$this->importe;

		// iva
		$this->iva = new cField('trama_medios2Dentrega', 'trama_medios-entrega', 'x_iva', 'iva', '`iva`', '`iva`', 4, -1, FALSE, '`iva`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->iva->Sortable = TRUE; // Allow sort
		$this->iva->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['iva'] = &$this->iva;

		// activo
		$this->activo = new cField('trama_medios2Dentrega', 'trama_medios-entrega', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trama_medios-entrega`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "trama_medios2Dentregalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trama_medios2Dentregaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trama_medios2Dentregaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trama_medios2Dentregaadd.php?" . $this->UrlParm($parm);
		else
			$url = "trama_medios2Dentregaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trama_medios2Dentregaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trama_medios2Dentregaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trama_medios2Dentregadelete.php", $this->UrlParm());
	}
