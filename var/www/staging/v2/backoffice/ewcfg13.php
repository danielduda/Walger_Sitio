...
define("EW_PROJECT_NAME", "walger_trama_ecommerce", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{8B1B047A-723B-431D-9264-98AA1CD60F92}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'E1y11dOoBo43dqBZ', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/walger_trama_ecommerce.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "walger0000", "db" => "walger_stg", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["walger1"] = array("conn" => NULL, "id" => "walger1", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "walger0000", "db" => "walger_stg", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[1] = &$EW_CONN["walger1"];
...
define("EW_USER_TABLE", "`walger_usuarios`", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "../img/", TRUE); // Upload destination path (relative to app root)
