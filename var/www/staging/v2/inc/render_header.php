              ...
              <div class="dropdown-menu text-center padding-md" aria-labelledby="dropdownMenu1">
                <form>
                  <div class="form-group">
                    <input type="text" class="form-control login-usuario" id="" placeholder="Usuario">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control login-contrasena" id="" placeholder="Contraseña">
                  </div>               
          ...
          <div class="col-md-6 no-padding ">
            <div class="<?php echo $GLOBALS["configuracion"]["carrito"]?"col-md-9 col-lg-10":"col-md-12 col-lg-12" ?>  no-padding text-right">
              <ul class="fa-ul">
                ...
                <li><h2 class="bold cl-color-1"><i class="fa <?php echo $GLOBALS["configuracion"]["contactos"][0]["icono"] ?> cl-color-4"></i> <?php echo $GLOBALS["configuracion"]["contactos"][0]["valor"] ?></h2></li>
                <?php 
                  $diashorarios=array();
              ...
              ?>
                <div class="col-md-3 col-lg-2 no-padding ">
                  <div class="dropdown pull-right">
                    <div id="btn-cart">
                      <button id="boton-cesta" class="btn cl-color-2 bg-color-3 dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
