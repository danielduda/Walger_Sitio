...
$trama_slider_add = NULL; // Initialize page object first

class ctrama_slider_add extends ctrama_slider {
	...
	// Page object name
	var $PageObjName = 'trama_slider_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "trama_sliderview.php")
...
// Create page object
if (!isset($trama_slider_add)) $trama_slider_add = new ctrama_slider_add();

// Page init
$trama_slider_add->Page_Init();

// Page main
$trama_slider_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trama_slider_add->Page_Render();
?>
...
var CurrentForm = ftrama_slideradd = new ew_Form("ftrama_slideradd", "add");

// Validate form
ftrama_slideradd.Validate = function() {
...
ftrama_slideradd.Form_CustomValidate = 
...
ftrama_slideradd.ValidateRequired = true;
<?php } else { ?>
ftrama_slideradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftrama_slideradd.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftrama_slideradd.Lists["x_activo"].Options = <?php echo json_encode($trama_slider->activo->Options()) ?>;
...
<?php if (!$trama_slider_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $trama_slider_add->ShowPageHeader(); ?>
<?php
$trama_slider_add->ShowMessage();
?>
<form name="ftrama_slideradd" id="ftrama_slideradd" class="<?php echo $trama_slider_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trama_slider_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trama_slider_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateEditor("ftrama_slideradd", "x_contenido", 35, 4, <?php echo ($trama_slider->contenido->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $trama_slider_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftrama_slideradd.Init();
</script>
<?php
$trama_slider_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$trama_slider_add->Page_Terminate();
?>
