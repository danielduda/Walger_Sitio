...
$trama_mensajes2Dclientes_grid = NULL; // Initialize page object first

class ctrama_mensajes2Dclientes_grid extends ctrama_mensajes2Dclientes {
	...
	// Page object name
	var $PageObjName = 'trama_mensajes2Dclientes_grid';

	// Grid form hidden field names
	var $FormName = 'ftrama_mensajes2Dclientesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["trama_mensajes2Dclientes"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_fecha") && $objForm->HasValue("o_fecha") && $this->fecha->CurrentValue <> $this->fecha->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_mensaje") && $objForm->HasValue("o_mensaje") && $this->mensaje->CurrentValue <> $this->mensaje->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->mensaje->setOldValue($objForm->GetValue("o_mensaje"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "dbo_cliente") {
			...
			if ($GLOBALS["dbo_cliente"]->EventCancelled) $this->EventCancelled = TRUE;
		}
