...
$trama_atributos2Dvalores_grid = NULL; // Initialize page object first

class ctrama_atributos2Dvalores_grid extends ctrama_atributos2Dvalores {
	...
	// Page object name
	var $PageObjName = 'trama_atributos2Dvalores_grid';

	// Grid form hidden field names
	var $FormName = 'ftrama_atributos2Dvaloresgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["trama_atributos2Dvalores"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_idAtributo") && $objForm->HasValue("o_idAtributo") && $this->idAtributo->CurrentValue <> $this->idAtributo->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_valor") && $objForm->HasValue("o_valor") && $this->valor->CurrentValue <> $this->valor->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->idAtributo->setOldValue($objForm->GetValue("o_idAtributo"));
		if (!$this->valor->FldIsDetailKey) {
			$this->valor->setFormValue($objForm->GetValue("x_valor"));
		}
		$this->valor->setOldValue($objForm->GetValue("o_valor"));
	}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "trama_atributos") {
			$this->idAtributo->Visible = FALSE;
			if ($GLOBALS["trama_atributos"]->EventCancelled) $this->EventCancelled = TRUE;
		}
