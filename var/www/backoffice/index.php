...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'trama_mensajes-clientes'))
			$this->Page_Terminate("trama_mensajes2Dclienteslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'trama_mensajes-publicos-leidos'))
			$this->Page_Terminate("trama_mensajes2Dpublicos2Dleidoslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'trama_articulos-imagenes-adicionales'))
			$this->Page_Terminate("trama_articulos2Dimagenes2Dadicionaleslist.php");
