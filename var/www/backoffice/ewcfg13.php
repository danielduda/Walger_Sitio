...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "walger0000", "db" => "walger", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["walger1"] = array("conn" => NULL, "id" => "walger1", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "walger0000", "db" => "walger", "qs" => "`", "qe" => "`", "new" => TRUE);
