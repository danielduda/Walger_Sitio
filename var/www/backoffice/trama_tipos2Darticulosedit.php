...
$trama_tipos2Darticulos_edit = NULL; // Initialize page object first

class ctrama_tipos2Darticulos_edit extends ctrama_tipos2Darticulos {
	...
	// Page object name
	var $PageObjName = 'trama_tipos2Darticulos_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("trama_tipos2Darticuloslist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// atributo1
			$this->atributo1->SetDbValueDef($rsnew, $this->atributo1->CurrentValue, NULL, $this->atributo1->ReadOnly);

			// atributo2
			$this->atributo2->SetDbValueDef($rsnew, $this->atributo2->CurrentValue, NULL, $this->atributo2->ReadOnly);

			// atributo3
			$this->atributo3->SetDbValueDef($rsnew, $this->atributo3->CurrentValue, NULL, $this->atributo3->ReadOnly);

			// atributo4
			$this->atributo4->SetDbValueDef($rsnew, $this->atributo4->CurrentValue, NULL, $this->atributo4->ReadOnly);
...
// Create page object
if (!isset($trama_tipos2Darticulos_edit)) $trama_tipos2Darticulos_edit = new ctrama_tipos2Darticulos_edit();

// Page init
$trama_tipos2Darticulos_edit->Page_Init();

// Page main
$trama_tipos2Darticulos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trama_tipos2Darticulos_edit->Page_Render();
?>
...
var CurrentForm = ftrama_tipos2Darticulosedit = new ew_Form("ftrama_tipos2Darticulosedit", "edit");

// Validate form
ftrama_tipos2Darticulosedit.Validate = function() {
...
ftrama_tipos2Darticulosedit.Form_CustomValidate = 
...
ftrama_tipos2Darticulosedit.ValidateRequired = true;
<?php } else { ?>
ftrama_tipos2Darticulosedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftrama_tipos2Darticulosedit.Lists["x_atributo1"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trama_atributos"};
ftrama_tipos2Darticulosedit.Lists["x_atributo2"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trama_atributos"};
ftrama_tipos2Darticulosedit.Lists["x_atributo3"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trama_atributos"};
ftrama_tipos2Darticulosedit.Lists["x_atributo4"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trama_atributos"};
...
<?php if (!$trama_tipos2Darticulos_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $trama_tipos2Darticulos_edit->ShowPageHeader(); ?>
<?php
$trama_tipos2Darticulos_edit->ShowMessage();
?>
<form name="ftrama_tipos2Darticulosedit" id="ftrama_tipos2Darticulosedit" class="<?php echo $trama_tipos2Darticulos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trama_tipos2Darticulos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trama_tipos2Darticulos_edit->Token ?>">
<?php } ?>
...
<?php if ($trama_tipos2Darticulos->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_trama_tipos2Darticulos_id" class="col-sm-2 control-label ewLabel"><?php echo $trama_tipos2Darticulos->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $trama_tipos2Darticulos->id->CellAttributes() ?>>
<span id="el_trama_tipos2Darticulos_id">
<span<?php echo $trama_tipos2Darticulos->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $trama_tipos2Darticulos->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="trama_tipos2Darticulos" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($trama_tipos2Darticulos->id->CurrentValue) ?>">
<?php echo $trama_tipos2Darticulos->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $trama_tipos2Darticulos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftrama_tipos2Darticulosedit.Init();
</script>
<?php
$trama_tipos2Darticulos_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$trama_tipos2Darticulos_edit->Page_Terminate();
?>
