...
$trama_categorias2Dproductos = NULL;

//
// Table class for trama_categorias-productos
//
class ctrama_categorias2Dproductos extends cTable {
	var $id;
	var $denominacion;
	var $descripcion;
	var $imagen;
	...
	function __construct() {
		...
		$this->TableVar = 'trama_categorias2Dproductos';
		$this->TableName = 'trama_categorias-productos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trama_categorias-productos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('trama_categorias2Dproductos', 'trama_categorias-productos', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('trama_categorias2Dproductos', 'trama_categorias-productos', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// descripcion
		$this->descripcion = new cField('trama_categorias2Dproductos', 'trama_categorias-productos', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagen
		$this->imagen = new cField('trama_categorias2Dproductos', 'trama_categorias-productos', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 200, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trama_categorias-productos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "trama_categorias2Dproductoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trama_categorias2Dproductosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trama_categorias2Dproductosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trama_categorias2Dproductosadd.php?" . $this->UrlParm($parm);
		else
			$url = "trama_categorias2Dproductosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trama_categorias2Dproductosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trama_categorias2Dproductosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trama_categorias2Dproductosdelete.php", $this->UrlParm());
	}
