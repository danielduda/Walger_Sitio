...
class cwalger_ofertas_edit extends cwalger_ofertas {
	...
	function ValidateForm() {
		...
		if (in_array("trama_mensajes2Dpublicos2Dleidos", $DetailTblVar) && $GLOBALS["trama_mensajes2Dpublicos2Dleidos"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("trama_mensajes2Dpublicos2Dleidos", $DetailTblVar) && $GLOBALS["trama_mensajes2Dpublicos2Dleidos"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["trama_mensajes2Dpublicos2Dleidos_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("trama_mensajes2Dpublicos2Dleidos", $DetailTblVar)) {
				...
				if ($GLOBALS["trama_mensajes2Dpublicos2Dleidos_grid"]->DetailEdit) {
					$GLOBALS["trama_mensajes2Dpublicos2Dleidos_grid"]->CurrentMode = "edit";
					$GLOBALS["trama_mensajes2Dpublicos2Dleidos_grid"]->CurrentAction = "gridedit";
...
<?php
	if (in_array("trama_mensajes2Dpublicos2Dleidos", explode(",", $walger_ofertas->getCurrentDetailTable())) && $trama_mensajes2Dpublicos2Dleidos->DetailEdit) {
?>
