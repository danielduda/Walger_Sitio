...
<?php } ?>
<link href="phpcss/walger_style.css" rel="stylesheet" type="text/css">
...
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("walger_favicon.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("walger_favicon.ico") ?>">
