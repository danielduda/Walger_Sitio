...
define("EW_ROOT_RELATIVE_PATH", "..\..\..\..\..\Documents and Settings\Federico Pfaffendorf\Mis documentos\PHPMaker\Projects\walger", TRUE); // Relative path of app root
...
define("EW_PROJECT_NAME", "walger", TRUE); // Project Name
define("EW_RANDOM_KEY", 'CDyDN5dWsBj83gGi', TRUE); // Random key for encryption
...
define("EW_XML_ENCODING", "iso-8859-1", TRUE); // Encoding for Export to XML
