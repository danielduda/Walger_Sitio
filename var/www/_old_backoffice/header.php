<html>
<head>
	<title>Walger - Backoffice</title>
<?php if (@$sExport == "" || @$sExport == "html") { ?>
<link href="walger.css" rel="stylesheet" type="text/css" />
<?php } ?>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr class="ewHeaderRow"><!-- *** Note: Only licensed users are allowed to change the logo *** -->
		<td height="50"><img src="aspmkrlogo6.png" alt="" border="0"></td>
	</tr>
	<!-- header (end) -->
	<!-- content (begin) -->
	<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td><span class="phpmaker"><b>Walger - Backoffice</b></span></td></tr>
</table>
<?php } ?>
